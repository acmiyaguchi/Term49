...
void prefs_emit_lua(const pref_t *prefs, const char *path) {
	...
	fputs("-- " APP_DISPLAY_NAME " configuration (Lua). Generated automatically; safe to\n"
	      ...
	      "--\n"
	      "-- Bundled font examples (when packaged with make stage-fonts):\n"
	      "--   font_path = os.getenv(\"SANDBOX\") .. \"/app/native/fonts/IosevkaTerm-Regular.ttf\"\n"
	      "--   font_path = os.getenv(\"SANDBOX\") .. \"/app/native/fonts/JetBrainsMono-Regular.ttf\"\n"
	      "--   font_path = os.getenv(\"SANDBOX\") .. \"/app/native/fonts/SourceCodePro-Regular.otf\"\n"
	      "--   font_path = os.getenv(\"SANDBOX\") .. \"/app/native/fonts/UbuntuMono-R.ttf\"\n"
	      "--\n"
